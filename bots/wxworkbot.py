...
class WxWorkBot:
    ...
    def get_image_data(self, image):
        ...
        bot_url = WxWorkBot.BOT_URL % ('send', self.bot_id)                                      #填上机器人Webhook地址 
    ...
    def upload_file(self, path:str) -> dict:
        ...
        url = WxWorkBot.FILE_UPLOAD_URL % (self.bot_id, WxWorkBot.FILE_UPLOAD_TYPE)
    ...
    def send_file(self, media_id:str) -> dict:
        bot_url = WxWorkBot.BOT_URL % ('send', self.bot_id)
        data = {
            "msgtype": "file",
            "file": {
                "media_id": media_id
